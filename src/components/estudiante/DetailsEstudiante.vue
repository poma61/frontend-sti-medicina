                ...
                <v-table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <v-chip color="cyan-darken-2" label>{{ props.p_item_estudiante.usuario.email }} </v-chip></td>
                        </tr>
                        <tr>
                            <td class="font-weight-bold">C.I.:</td>
                            <td>{{ props.p_item_estudiante.ci }}  {{ props.p_item_estudiante.ci_expedido }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{{ format(parseISO(props.p_item_estudiante.fecha_nacimiento), 'dd/MMMM/yyyy', { locale: es }) }}
                            </td>
                        </tr>
                        <tr>
                            <td class="font-weight-bold">Número de contacto:</td>
                            <td> <v-chip color="cyan-darken-2" label> {{ props.p_item_estudiante.numero_contacto }} </v-chip>
                            </td>
                        </tr>

                        <tr>
                            <td class="font-weight-bold">Matricula universitaria:</td>
                            <td> <v-chip color="cyan-darken-2" label>{{ props.p_item_estudiante.matricula_univ }} </v-chip></td>
                        </tr>
                        <tr>
